...
java// variable type = NetworkDevice (parent)
...
javaNetworkDevice[] network = {device1, device2, device3};
...
javafor (NetworkDevice device : network) {
...
javaif (device instanceof Server) {
...
javaNetworkDevice nd = new Server("FileServer-01", "192.168.1.30", true, 200, 150);
...
Full Programs
NetworkDevice.java
javapublic class NetworkDevice {
...
Server.java
javapublic class Server extends NetworkDevice {
...
Router.java
javapublic class Router extends NetworkDevice {
...
javapublic class Day20Polymorphism {
